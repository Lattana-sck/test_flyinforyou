  ...
  return (
    <>
      <div className="bg-[url('https://flying-for-you-data.s3.eu-west-3.amazonaws.com/website-images/bulle-google-avis.webp')] min-h-screen">
          <h1 className="text-center text-5xl mt-[10px]">Liste de films</h1>
        <div className="hover:opacity-100 w-[15%] bg-white opacity-80 justify-center item-center text-center m-auto border p-10 border-solid border-4 rounded-lg mb-[20px] mt-[20px]">
          <form className="flex flex-col">
            <input
              className="border text-center bg-white-200 h-[50px]"
              type="text"
